...
NAME = 'echarts-china-counties-pypkg'
...
URL = 'https://github.com/pyecharts/echarts-china-counties-pypkg'
...
SETUP_COMMANDS = install_cmd_for(
    ...
    'echarts_china_counties_pypkg/resources/echarts-china-counties-js')
...
PUBLISH_COMMAND = '{0} setup.py sdist upload -r pypi'.format(
    sys.executable)
GS_COMMAND = ('gs echarts-china-counties-pypkg v0.0.1 ' +
...
class PublishCommand(Command):
    ...
    def run(self):
        try:
            ...
            rmtree(os.path.join(HERE, 'echarts_china_counties_pypkg.egg-info'))
        except OSError:
            pass
